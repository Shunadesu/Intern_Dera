...
const WhyBanner = () => {
  return (
    ...
    md-max-4:px-8
    md-max-5:px-2
    py-32 flex flex-col gap-8 justify-center items-center'>
        ...
        md-max-2:grid md-max-2:grid-cols-2 md-max-2:px-0 md-max-2:justify-items-center
        md-max-3:justify-around md-max-3:gap-8
        md-max-4:gap-4
        '>
            {
                WhyData.map((data)=>(
                    <div key={data.id} className='flex flex-col gap-3 w-[300px] md-max-2:w-[250px] md-max-3:w-[180px] md-max-3:items-center md-max-3:text-center'>
                        <div className='w-[50px] h-[50px] my-4 relative '>
                            <div className='text-[#999999] hover:text-[#658C4A] transition-all duration-300'>
                                {data.icon}
                            </div>
                        </div>
